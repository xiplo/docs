...
# Pre-built segments for Uzbek market
DEFAULT_SEGMENTS = [
    AudienceSegment(
        id="uz_youth",
        name="Uzbek Youth",
        description="Young Uzbeks in major cities, digital-native",
        age_range="18-24",
        locations=["Tashkent", "Samarkand", "Bukhara"],
        languages=["uz", "ru"],
        preferred_content=["reel", "story"],
        preferred_categories=["motivational", "lifestyle", "education"],
        engagement_level="high",
        active_platforms=["instagram", "tiktok", "telegram"],
        stage="active",
        size_estimate=50000,
    ...
    AudienceSegment(
        id="uz_professionals",
        name="Uzbek Professionals",
        description="Working professionals 25-40, career-focused",
        age_range="25-40",
        locations=["Tashkent"],
        languages=["uz", "ru", "en"],
        preferred_content=["image", "carousel"],
        preferred_categories=["motivational", "education", "lifestyle"],
        engagement_level="medium",
        active_platforms=["instagram", "linkedin", "telegram"],
        stage="active",
        size_estimate=30000,
    ...
    AudienceSegment(
        id="uz_foodies",
        name="Uzbek Foodies",
        description="Food enthusiasts, home cooks, traditional cuisine lovers",
        age_range="25-45",
        ...
        engagement_level="high",
        active_platforms=["instagram", "facebook", "tiktok", "youtube"],
        stage="engaged",
        size_estimate=40000,
    ...
    AudienceSegment(
        ...
        description="English-speaking travelers interested in Uzbekistan",
        age_range="25-55",
        ...
        engagement_level="medium",
        active_platforms=["instagram", "youtube", "pinterest", "tiktok"],
        stage="new",
        size_estimate=15000,
